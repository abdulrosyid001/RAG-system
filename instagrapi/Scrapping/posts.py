...
account_data = scraper.get_account("rosyidcoc")
if not account_data:
    print("❌ Error: Account 'rosyidcoc' not found in database!")
    exit(1)
...
def fetch_medias_with_pagination(scraper, user_id, amount=500):
    """
...
try:
    ...
    for target_username in usernames:
        try:
            ...
            # ← UBAH: gunakan pagination dengan amount=100
            medias = fetch_medias_with_pagination(scraper, user_id, amount=500)
