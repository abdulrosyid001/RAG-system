...
class InstagramScraper:
    ...
    def __init__(
        ...
        db_name: str = "instagram_research",
        db_user: str = "postgres",
        db_password: str = "indojayaraya",
        db_port: int = 5432,
        headless: bool = False,
    ):
        """
...
if __name__ == "__main__":
    ...
    try:
        # Login
        scraper.login(username="rosyidcoc", password="@Indojayaraya1945")
        ...
        results = scraper.scrape_user_posts(
            username="dimasramadhan",           # Username tanpa @
            max_posts=100,                   # Jumlah post yang mau di-scrape
            max_comments_per_post=50,      # Max komentar per post
